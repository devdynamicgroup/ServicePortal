...
function buildContactAdminAckMessage() {
  ...
  return {
    type: 'text',
    text: 'รับทราบครับ ข้อความถึงเจ้าหน้าที่แล้ว เดี๋ยวเจ้าหน้าที่จะติดต่อกลับครับ 🙏'
  };
}
