...
| Key | Env var | Use |
|-----|---------|-----|
| `main` | `GOOGLE_DRIVE_MAIN_FOLDER_ID` | **Images only**: meter, tap, payment slip, OCR photo copies |
| `data` | `GOOGLE_DRIVE_DATA_FOLDER_ID` | **JSON / data files only**: assessment JSON, exports, metadata, reports |
